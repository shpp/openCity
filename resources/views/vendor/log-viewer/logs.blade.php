            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-default pull-left" data-dismiss="modal">Відмінити
                        </button>
        ...
        $(function () {
            ...
            $("a[href=#delete-log-modal]").on('click', function (event) {
                ...
                deleteLogModal.find('.modal-body p').html(
                    'Ви впевнені, що хочете <span class="label label-danger" style="text-transform: uppercase;">Видалити</span>' +
                    ' цей лог файл<span class="label label-primary">' + date + '</span> ?'
                );
